...
INSERT INTO course
    (courseID,		type,	number_of_credits,	faculty_ID,	lecturerID,	weekDay,	classroomID,	startSession,	endSession,	startDate,		endDate,		courseName)
VALUES
        -- CNTT
    ("COMP101601",  0,	    3,				    1,		    "NDTH",		3,			"ADV_I202",		1,				5,			"2022-02-26",	"2022-05-15",	"Cấu trúc dữ liệu"),
    ("COMP101602",  0,	    3,				    1,		    "NDTH",		3,			"ADV_I202",		7,				11,			"2022-02-26",	"2022-05-15",	"Cấu trúc dữ liệu"),
    ("COMP101701",  0,	    3,				    1,		    "LTNK",		3,			"ADV_I202",		1,				6,			"2022-02-26",	"2022-05-15",	"Lập trình hướng đối tượng"),
    ("COMP101702",  0,	    3,				    1,		    "LTNK",		3,			"ADV_I202",		7,				12,			"2022-02-26",	"2022-05-15",	"Lập trình hướng đối tượng"),
    ("COMP130301",  0,	    3,				    1,		    "LTHH",		4,			"ADV_I201",		1,				6,			"2022-02-16",	"2022-05-25",	"Phát triển ứng dụng web"),
    ("COMP130302",  0,	    3,				    1,		    "LTHH",		5,			"ADV_I201",		7,				12,			"2022-02-17",	"2022-05-26",	"Phát triển ứng dụng web"),
    ("COMP170101",  0,	    3,				    1,		    "NVH",		2,			"LVS_D104",		1,				6,			"2022-02-16",	"2022-05-25",	"Lý thuyết đồ thị"),
    ("COMP170102",  0,	    3,				    1,		    "NVH",		2,			"LVS_I104",		7,				12,			"2022-02-16",	"2022-05-25",	"Lý thuyết đồ thị"),
    ("MATH101001",  0,	    2,				    1,		    "NTHT",		6,			"ADV_104",		1,				5,			"2022-03-14",	"2022-05-04",	"Toán rời rạc"),
    ("MATH101002",  0,	    2,				    1,		    "NTHT",		6,			"ADV_104",		7,				11,			"2022-03-14",	"2022-05-04",	"Toán rời rạc"),
    ("COMP101001",  0,	    3,				    1,		    "THQT",		7,			"ADV_I102",		1,				5,			"2022-03-02",	"2022-05-30",	"Lập trình cơ bản"),
    ("COMP101002",  0,	    3,				    1,		    "THQT",		7,			"ADV_I102",		7,				11,			"2022-03-02",	"2022-05-30",	"Lập trình cơ bản"),
    ("COMP101901",  0,	    3,				    1,		    "TTN",		2,			"ADV_103",		1,				6,			"2022-09-19",	"2022-11-06",	"Lập trình Windows"),
    ("COMP101902",  0,	    3,				    1,		    "TTN",		2,			"ADV_103",		7,				12,			"2022-09-19",	"2022-11-06",	"Lập trình Windows"),
    ("COMP101903",  0,	    3,				    1,		    "LTHH",		3,			"ADV_103",		1,				6,			"2022-09-20",	"2022-11-07",	"Lập trình Windows")
;

INSERT INTO course
    (courseID,		type,   number_of_credits,	facultyID,	lecturerID,	weekDay,	classroomID,	startSession,	endSession,	startDate,		endDate,		courseName)
VALUES
        -- CNTT
-- 	("MATH100201",	0,      3,  				1,          "BTQ",		4,			"ADV_B305",		1,				5,			"2022-03-13",	"2022-05-16",	"Giải tích"),
-- 	("MATH100202",	0,      3,  				1,          "BTQ",		4,			"ADV_B305",		7,				11,			"2022-03-13",	"2022-05-16",	"Giải tích"),
-- 	("MATH110801",	0,      3,  				1,          "NDL",		5,			"ADV_B203",		1,				5,			"2022-09-04",	"2022-10-23",	"Đại số tuyến tính"),
-- 	("MATH110802",	0,      3,  				1,          "NDL",		6,			"ADV_B203",		1,				5,			"2022-09-05",	"2022-10-24",	"Đại số tuyến tính"),
-- 	("COMP150101",	0,      3,  				1,          "THH",		3,			"ADV_B305",		1,				5,			"2022-02-25",	"2022-04-02",	"Xác xuất thống kê và ứng dụng"),
-- 	("COMP150102",	0,      3,  				1,          "THH",		3,			"ADV_B305",		7,				11,			"2022-02-25",	"2022-04-02",	"Xác xuất thống kê và ứng dụng"),
    ("COMP150103",	0,      3,  				1,          "NTHT",		3,			"ADV_B308",		1,				5,			"2022-02-25",	"2022-04-02",	"Xác xuất thống kê và ứng dụng"),
    ("COMP120501",	0,      2,  				1,          "LDL",		2,			"LLQ_D205",		1,				4,			"2022-02-18",	"2022-03-30",	"Phương pháp nghiên cứu khoa học"),	
    ("COMP120502",	0,      2,  				1,          "LDL",		2,			"LLQ_D205",		7,				10,			"2022-02-18",	"2022-03-30",	"Phương pháp nghiên cứu khoa học"),
    ("COMP106401",	1,      3,  				1,          "LTHH",		6,			"ADV_I103",		2,				6,			"2023-09-09",	"2022-10-24",	"Công nghệ NET"),
    ("COMP106402",	1,      3,  				1,          "LTHH",		5,			"ADV_I103",		1,				5,			"2023-09-08",	"2022-10-23",	"Công nghệ NET"),
    ("COMP106403",	1,      3,  				1,          "MVPV",		6,			"ADV_C103",		2,				6,			"2023-09-09",	"2022-10-24",	"Công nghệ NET"),
    ("COMP130701",	1,      3,  				1,          "TSH",		4,			"ADV_I202",		7,				9,			"2023-09-06",	"2023-10-24",	"Kiểm thử phần mềm cơ bản"),
    ("COMP130702",	1,      3,  				1,          "TSH",		4,			"ADV_I202",		1,				3,			"2023-09-06",	"2023-10-24",	"Kiểm thử phần mềm cơ bản"),
    ("COMP131301",	1,      3,  				1,          "NHBL",		2,			"ADV_C202",		1,				5,			"2023-02-28",	"2022-04-03",	"Điện toán đám mây"),
    ("COMP131302",	1,      3,  				1,          "NHBL",		2,			"ADV_C202",		7,				11,			"2023-02-28",	"2022-04-03",	"Điện toán đám mây"),
-- 	("COMP101101",	1,      3,  				1,          "NDTN",		7,			"ADV_I102",		1,				5,			"2023-03-02",	"2022-04-23",	"Kiến trúc máy tính và hợp ngữ"),
-- 	("COMP101102",	1,      3,  				1,          "NDTN",		7,			"ADV_I102",		7,				11,			"2023-03-02",	"2022-04-23",	"Kiến trúc máy tính và hợp ngữ"),
-- 	("COMP133201",	1,      3,  				1,          "TDT",		5,			"ADV_B315",		1,				5,			"2023-09-06",	"2023-11-22",	"Hệ điều hành"),
-- 	("COMP133202",	1,      3,  				1,          "TDT",		5,			"ADV_B315",		7,				11,			"2023-09-06",	"2023-11-22",	"Hệ điều hành"),
    ("COMP140101",	1,      3,  				1,          "NQV",		4,			"ADV_B214",		1,				6,			"2022-09-30",	"2022-11-05",	"Phân tích thiết kế và giải thuật"),
    ("COMP140102",	1,      3,  				1,          "NQV",		4,			"ADV_B214",		7,				12,			"2022-09-30",	"2022-11-05",	"Phân tích thiết kế và giải thuật"),
    ("COMP140103",	1,      3,  				1,          "VTT",		3,			"ADV_B215",		1,				6,			"2022-09-29",	"2022-11-04",	"Phân tích thiết kế và giải thuật"),
    ("COMP101801",	1,      3,  				1,          "DTT",		2,			"ADV_C204",		2,				6,			"2022-09-29",	"2022-11-03",	"Cơ sở dữ liệu"),
    ("COMP101802",	1,      3,  				1,          "DTT",		2,			"ADV_C204",		8,				12,			"2022-09-29",	"2022-11-03",	"Cơ sở dữ liệu"),
    ("COMP101803",	1,      3,  				1,          "MNG",		3,			"ADV_C204",		2,				6,			"2022-09-30",	"2022-11-05",	"Cơ sở dữ liệu"),
    ("COMP101804",	1,      3,  				1,          "LTNK",		3,			"ADV_C204",		8,				12,			"2022-09-30",	"2022-11-04",	"Cơ sở dữ liệu"),
    ("COMP102401",	1,      3,  				1,          "LTNK",		5,			"ADV_I102",		1,				5,			"2023-09-19",	"2023-10-30",	"Các hệ cơ sở dữ liệu"),
    ("COMP102402",	1,      3,  				1,          "LTNK",		5,			"ADV_I102",		7,				11,			"2023-09-19",	"2023-10-30",	"Các hệ cơ sở dữ liệu"),
    ("COMP102403",	1,      3,  				1,          "LMT",		4,			"ADV_I102",		1,				5,			"2023-09-18",	"2023-10-29",	"Các hệ cơ sở dữ liệu"),
    ("COMP106001",	1,      3,  				1,          "VTT",		6,			"ADV_B218",		1,				3,			"2023-03-02",	"2023-04-12",	"Phân tích thiết kế hướng đối tượng"),
-- 	("COMP106001",	1,      3,  				1,          "NVT",		6,			"ADV_B218",		4,				6,			"2023-03-02",	"2023-04-12",	"Phân tích thiết kế hướng đối tượng"),
    ("COMP131401",	1,      3,  				1,          "LTNK",		7,			"ADV_B315",		1,				3,			"2023-09-22",	"2023-11-05",	"Trí tuệ nhân tạo"),
    ("COMP131402",	1,      3,  				1,          "LTNK",		7,			"ADV_B315",		4,				6,			"2023-09-22",	"2023-11-05",	"Trí tuệ nhân tạo")
;
